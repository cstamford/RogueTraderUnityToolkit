...
public sealed class MultiMemoryStream : Stream, IDisposable
{
    ...
    public MultiMemoryStream Slice(int offset, int length)
    {
        ...
        return new MultiMemoryStream([.. slicedRegions]);
    }
    ...
    private IRelocatableMemoryRegion? _primedRegion = null;
    private ReadOnlyMemory<byte> _primedRegionMemory = default;
    private int _primedRegionOffset = 0;
    private int _primedRegionLength = 0;
