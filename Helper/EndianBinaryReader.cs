...
public sealed class EndianBinaryReader(Stream stream, bool isBigEndian = true)
{
    ...
    public string ForDebugger => this.Dump();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public unsafe bool ReadB32() => ReadB32(out uint _);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public unsafe bool ReadB8() => ReadB8(out byte _);
    ...
    public unsafe string ReadStringUntilNull()
    {
        ...
        while (true)
        {
            ...
            int nullIdx = Util.FastFindNull(scratchSlice);
        ...
        Position = startPos;
        string str = ReadString(stringLength);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public unsafe int ReadBytes(Span<byte> span)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public unsafe int PeekBytes(Span<byte> span, int offset = 0)
    {
...
public static class EndianBinaryReaderExtensions
{
    ...
    public static Guid ReadGuid(this EndianBinaryReader reader)
    {
        ...
        {
            reader.ReadSwap32(bytes.Slice(4, 4));
        }
