...
/* $BoxCollider (10 fields) BoxCollider 9EF330076498F7F0DE7391D10B15E1AB */
...
{
    public static UnityObjectType ObjectType => UnityObjectType.BoxCollider;
    public static Hash128 Hash => new("9EF330076498F7F0DE7391D10B15E1AB");
    public static BoxCollider Read(EndianBinaryReader reader)
    {
        ...
        Vector3f m_Size_ = Vector3f.Read(reader);
    ...
    {
        sb.Append($"{indent_}m_Size: {{ x: {m_Size.x}, y: {m_Size.y}, z: {m_Size.z} }}\n");
    }
