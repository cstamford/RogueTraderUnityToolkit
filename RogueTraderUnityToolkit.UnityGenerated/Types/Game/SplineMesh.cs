...
/* $SplineMesh (41 fields) 15B48C10AD20D6AFCA085DC9E9C53FA7/8762DA8157C526EB163BB5416AF80AEF */
public record class SplineMesh(
    ...
    Channel[] _channels /* None */)
{
    public static SplineMesh Read(EndianBinaryReader reader)
    {
        ...
        Channel[] __channels = BuiltInArray<Channel>.Read(reader);
