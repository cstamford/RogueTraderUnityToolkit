...
/* $LoadingScreenPCView (51 fields) 1B12CE90DF07C798A1BE8706D51AF991/A188C60DD78F1FB7D9691C19ED8B912D */
public record class LoadingScreenPCView(
    ...
    float m_DefaultFontTitleSize /* NeedsAlign */,
    float m_DefaultFontDescriptionSize /* None */)
{
    public static LoadingScreenPCView Read(EndianBinaryReader reader)
    {
        ...
        SettingTypeScreens[] _m_SettingTypeScreensList = BuiltInArray<SettingTypeScreens>.Read(reader);
        ...
        reader.AlignTo(4); /* m_DefaultFontTitleSize */
        float _m_DefaultFontTitleSize = reader.ReadF32();
        float _m_DefaultFontDescriptionSize = reader.ReadF32();
        ...
        return new(_m_GameObject,
            ...
            _m_DefaultFontTitleSize,
            _m_DefaultFontDescriptionSize);
    }
}
