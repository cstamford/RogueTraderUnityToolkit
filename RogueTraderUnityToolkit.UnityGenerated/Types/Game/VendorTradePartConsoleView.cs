...
/* $VendorTradePartConsoleView (31 fields) 65B6DE22ED2DE45BFAEB1D38B0B4F5AD/47C9106BB999B1BBD56FA80913815918 */
public record class VendorTradePartConsoleView(
    ...
    PPtr<ItemsFilterConsoleView> m_VendorItemsFilter /* None */,
    PPtr<VendorLevelItemsConsoleView> m_VendorSlotPrefab /* None */,
    ...
    PPtr<VendorTransitionWindowConsoleView> m_TransitionWindowPCView /* None */,
...
{
    public static VendorTradePartConsoleView Read(EndianBinaryReader reader)
    {
        ...
        PPtr<ItemsFilterConsoleView> _m_VendorItemsFilter = PPtr<ItemsFilterConsoleView>.Read(reader);
        PPtr<VendorLevelItemsConsoleView> _m_VendorSlotPrefab = PPtr<VendorLevelItemsConsoleView>.Read(reader);
        ...
        PPtr<VendorTransitionWindowConsoleView> _m_TransitionWindowPCView = PPtr<VendorTransitionWindowConsoleView>.Read(reader);
