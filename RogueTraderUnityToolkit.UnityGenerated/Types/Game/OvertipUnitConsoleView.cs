...
/* $OvertipUnitConsoleView (26 fields) 4F1501F4B0ED3307411D30048FEC13BF/CFE5D7E129509EE16E9F0D54665DD822 */
public record class OvertipUnitConsoleView(
    ...
    PPtr<FadeAnimator> m_DeathAnimator /* None */,
    float m_DeathDelay /* None */,
...
{
    public static OvertipUnitConsoleView Read(EndianBinaryReader reader)
    {
        ...
        PPtr<FadeAnimator> _m_DeathAnimator = PPtr<FadeAnimator>.Read(reader);
        float _m_DeathDelay = reader.ReadF32();
