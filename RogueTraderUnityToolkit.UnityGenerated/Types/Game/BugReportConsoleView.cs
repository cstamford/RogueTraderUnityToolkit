...
/* $BugReportConsoleView (53 fields) 0E67A94C0FF2CDB436D12F1BE2CAABED/FE749569F9C5F5DF4F13D5C34F570EC2 */
public record class BugReportConsoleView(
    ...
    PPtr<CanvasGroup> m_OpenBugReportGroup /* None */,
    PPtr<TextMeshProUGUI> m_OpenBugReportText /* None */,
    PPtr<ConsoleHint> m_FirstOpenBugReportHint /* None */,
    PPtr<ConsoleHint> m_SecondOpenBugReportHint /* None */,
    PPtr<ConsoleHint> m_SendHint /* None */,
    PPtr<ConsoleHintsWidget> m_HintsWidget /* None */)
{
    public static BugReportConsoleView Read(EndianBinaryReader reader)
    {
        ...
        PPtr<CanvasGroup> _m_OpenBugReportGroup = PPtr<CanvasGroup>.Read(reader);
        PPtr<TextMeshProUGUI> _m_OpenBugReportText = PPtr<TextMeshProUGUI>.Read(reader);
        PPtr<ConsoleHint> _m_FirstOpenBugReportHint = PPtr<ConsoleHint>.Read(reader);
        PPtr<ConsoleHint> _m_SecondOpenBugReportHint = PPtr<ConsoleHint>.Read(reader);
        PPtr<ConsoleHint> _m_SendHint = PPtr<ConsoleHint>.Read(reader);
        ...
        return new(_m_GameObject,
            ...
            _m_OpenBugReportGroup,
            _m_OpenBugReportText,
            _m_FirstOpenBugReportHint,
            _m_SecondOpenBugReportHint,
            _m_SendHint,
            _m_HintsWidget);
    }
}
