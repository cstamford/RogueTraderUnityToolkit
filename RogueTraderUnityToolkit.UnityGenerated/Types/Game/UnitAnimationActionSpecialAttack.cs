...
/* $UnitAnimationActionSpecialAttack (11 fields) C43653A34E350636CB672F49511F1D6E/7CA87E04369C75A77A825D016D1D9CCD */
public record class UnitAnimationActionSpecialAttack(
    ...
    int m_AttackType /* None */,
    Entry m_Attacks /* None */)
{
    public static UnitAnimationActionSpecialAttack Read(EndianBinaryReader reader)
    {
        ...
        int _m_AttackType = reader.ReadS32();
        Entry _m_Attacks = Entry.Read(reader);
