...
/* $TextMeshProUGUI (71 fields) EABAFF465C9C2501AF77E67EA83ED9EF/9F54789D7696CD3BD2272772B25597A6 */
public record class TextMeshProUGUI(
    ...
    byte m_hasFontAssetChanged /* NeedsAlign */,
    PPtr<Material> m_baseMaterial /* NeedsAlign */,
    Vector4f m_maskOffset /* None */)
{
    public static TextMeshProUGUI Read(EndianBinaryReader reader)
    {
        ...
        reader.AlignTo(4); /* m_hasFontAssetChanged */
        byte _m_hasFontAssetChanged = reader.ReadU8();
        reader.AlignTo(4); /* m_baseMaterial */
        PPtr<Material> _m_baseMaterial = PPtr<Material>.Read(reader);
        Vector4f _m_maskOffset = Vector4f.Read(reader);
