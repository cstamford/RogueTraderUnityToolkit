namespace RogueTraderUnityToolkit.Unity.Generated;
    ...
    float outWeight)
{
    public static Keyframe Read(EndianBinaryReader reader)
    {
        ...
        float inSlope = reader.ReadF32();
        float outSlope = reader.ReadF32();
        int weightedMode = reader.ReadS32();
        float inWeight = reader.ReadF32();
        float outWeight = reader.ReadF32();
