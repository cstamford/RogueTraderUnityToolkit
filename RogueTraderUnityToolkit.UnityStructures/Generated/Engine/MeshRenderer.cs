...
/* $MeshRenderer (27 fields) (IsEngineType) */
public record class MeshRenderer(
    ...
    PPtr<Mesh> m_EnlightenVertexStream)
{
    public static MeshRenderer Read(EndianBinaryReader reader)
    {
        ...
        PPtr<Mesh> m_AdditionalVertexStreams = PPtr<Mesh>.Read(reader);
        PPtr<Mesh> m_EnlightenVertexStream = PPtr<Mesh>.Read(reader);
